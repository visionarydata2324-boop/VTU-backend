...
import { ValidationError } from '@/utils/types/payment';
import {InitiatePaymentRequest} from '@/utils/types/payment'
...
export const validatePaymentRequest = (
  req: Request<{}, {}, InitiatePaymentRequest>,
  res: Response,
  next: NextFunction
): Response | void => {
...
export type { InitiatePaymentRequest, ValidationError };